...
scoreboard players remove @s[scores={dod_warlock_dammage=1..}] dod_warlock_souls 2
scoreboard players reset @s[scores={dod_warlock_dammage=1..}] dod_warlock_dammage
