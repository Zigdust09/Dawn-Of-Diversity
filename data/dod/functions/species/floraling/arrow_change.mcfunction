...
execute if block ~ ~ ~ red_tulip run data merge entity @s {Item:{id:"minecraft:tipped_arrow",tag:{custom_potion_effects:[{id:"minecraft:instant_healt",amplifier:1b,duration:800}]}}}
...
execute if block ~ ~ ~ pink_tulip run data merge entity @s {Item:{id:"minecraft:tipped_arrow",tag:{custom_potion_effects:[{id:"minecraft:instant_damag",amplifier:1b,duration:800}]}}}
...
execute if block ~ ~ ~ pitcher_plant run data merge entity @s {Item:{id:"minecraft:tipped_arrow",tag:{custom_potion_effects:[{id:"minecraft:saturation",amplifier:1b,duration:800}]}}}
...
execute if block ~ ~ ~ spore_blossom run data merge entity @s {Item:{id:"minecraft:tipped_arrow",tag:{custom_potion_effects:[{id:"minecraft:poison 6",amplifier:1b,duration:80000}]}}}
