...
execute as @s[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",tag:{end_sprinters_wand:1b}}},scores={dod_warped_right_click=1..}] unless score @s dod_end_sprinter_cooldown matches 1.. at @s anchored eyes run function dod:species/end_sprinter/end_sprinter_raycast_start
